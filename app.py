...
# - Output the reconciliation as a CSV file with the following fields:
...
#     # Try first: search for proper ```csv fenced block
#     csv_pattern = r"```csv\s*(.*?)```"

#     # Now it's safe to use gpt_output
